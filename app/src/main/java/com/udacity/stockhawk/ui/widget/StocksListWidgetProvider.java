...
/**
 * Created by vinsce on 22/01/17 at 22.47.
 *
 * @author vinsce
 */
...
public class StocksListWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (QuoteSyncJob.ACTION_DATA_UPDATED.equals(intent.getAction()) || MainActivity.ACTION_ITEM_DELETED.equals(intent.getAction())) {
    ...
    private void setRemoteAdapter(Context context, @NonNull final RemoteViews views) {
        views.setRemoteAdapter(R.id.widget_list,
                new Intent(context, StocksWidgetRemoteViewService.class));
    }
